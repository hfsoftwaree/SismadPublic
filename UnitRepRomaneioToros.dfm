object RepRomaneioToros: TRepRomaneioToros
  Left = 189
  Top = 140
  Width = 820
  Height = 578
  Caption = 'RepRomaneioToros'
  Color = clBtnFace
  ...
  object TENTRADA: TIBTable
    ...
    Left = 263
    Top = 448
    object TENTRADACODEMPRESA: TFloatField
    ...
    object TENTRADAVLUNITARIO: TFloatField
      FieldName = 'VLUNITARIO'
    end
    object TENTRADAVLTOTAL: TFloatField
      FieldName = 'VLTOTAL'
    end
    object TENTRADACODLANCAMENTO: TIntegerField
      FieldName = 'CODLANCAMENTO'
    end
    object TENTRADACODESSENCIA: TFloatField
